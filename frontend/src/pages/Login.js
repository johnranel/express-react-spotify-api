    ...
    return (
        <main className="bg-gradient-to-b grid from-neutral-500 via-neutral-800 to-neutral-900">
            <section className="grid order-2 md:order-1 py-10 h-screen md:h-[calc(100vh-60px)]">
                <div className="w-[500px] px-10 py-10 place-self-center bg-neutral-100 bg-opacity-10 rounded-xl">
                    <div className="flex flex-col items-center jusitfy-center">
                        ...
                        <button className="border-green-600 border-2 text-xl py-3 px-10 rounded-full text-neutral-100 hover:bg-green-600 transition-all">Spotify Authentication</button>
                    </div>
                </div>
            </section>
            <Footer />
