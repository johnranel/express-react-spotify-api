            ...
            <section className="grid order-2 md:order-1 py-10">
                <div className="container px-10 pb-10 place-self-center bg-neutral-100 bg-opacity-10 rounded-xl">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
                        <div className="bg-neutral-100 bg-opacity-10 grid justify-center items-center py-10 rounded-3xl">
                            <div className="w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] bg-gray-300 rounded-full mb-5"></div>
